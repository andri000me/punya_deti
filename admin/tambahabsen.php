    ...
    <div class="page-wrapper">
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <h4 class="card-title">Insert absen</h4>
                        <hr class="bg-primary">
                        <div class="row">
                            <div class="col-lg-12"> 
                                <div class="card">
                                    ...
                                    <form action="../admin/simpantmbhsis.php" method="POST" enctype="multipart/form-data">
                                      <div class="row">
                                          <div class="col-lg-6">
                                            ...
                                            <div class="m-t-20">
                                                <h5><b>Absensi : </b></h5>
                                                 <input type="text" class="form-control" maxlength="40" name="izin" id="alloptions" placeholder="Izin" required>
                                                 <input type="text" class="form-control" style="margin-top: 10px" maxlength="40" name="sakit" id="alloptions" placeholder="Sakit" required>
                                                 <input type="text" class="form-control" style="margin-top: 10px" maxlength="40" name="alpha" id="alloptions" placeholder="Alpha" required>
                                            </div>
                                            <div class="m-t-20">
