                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                      <h4 class="card-title">Data Guru</h4>
                        <a href="tambahguru.php"><button type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus">   Insert Data</i></button></a>
                        <hr class="bg-primary">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="table-responsive">
                                      <table class="table table-bordered" width="100%" cellspacing="0" id="myTable">
                                            ...
                                            <?php
                                             ...
                                             $r = mysqli_query($conn, 'SELECT * FROM guru');
                                                            ...
                                                            <div class="btn-group">
                                                              <div class="btn-group">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                  <a class="dropdown-item" href="../admin/editguru.php?nip=<?= $rows['nip']?>">Edit</a>
                                                                  <a class="dropdown-item" href="#">Hapus</a>
                                                                  <a class="dropdown-item" href="../admin/detailguru.php?nip=<?= $rows['nip']?>">Detail</a>
                                                                </div>
                                                              </div>
                                                            </div>
                                                        </td>
