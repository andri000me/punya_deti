                                        ...
                                        <table class="table" width="100%">
                                            <thead>
                                                <tr>
                                                    <th width="25%">NIS</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['nis']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">NISN</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['nisn']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">NAMA</th>
                                                    <th width="5%">:</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['tempat']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">TANGGAL LAHIR</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['tanggal_lahir']?></th>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['agama']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">PENDIDIKAN SEBELUMNYA</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['pendidikan_sebelumnya']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">ALAMAT SISWA</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['alamat_siswa']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">KELAS</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['kelas']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">SEMESTER</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['semester']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="100%" colspan="3">NAMA ORANG TUA</th>
                                                </tr>
                                                 <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     AYAH</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['na_ayah']?></th>
                                                </tr>
                                                 <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     IBU</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['na_ibu']?></th>
                                                </tr>
                                                 <tr>
                                                    <th width="100%" colspan="3">PEKERJAAN ORANG TUA</th>
                                                </tr>
                                                 <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     AYAH</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['pek_ayah']?></th>
                                                </tr> <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     IBU</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['pek_ibu']?></th>
                                                </tr> 
                                                <tr>
                                                    <th width="100%" colspan="3">WALI SISWA</th>
                                                </tr>
                                                 <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     NAMA</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['na_wali']?></th>
                                                </tr>
                                                 <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     PEKERJAAN</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['pek_wali']?></th>
                                                </tr>
                                                 <tr>
                                                    <th width="25%">&nbsp;&nbsp;&nbsp;     Alamat</th>
                                                    <th width="5%">:</th>
                                                    <th width="70%"><?= $rows['alamat_wali']?></th>
                                                </tr>
                                                <tr>
                                                    <th width="25%">FOTO</th>
                                                    <th width="5%">:</th>
