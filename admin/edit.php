...
$r = mysqli_query($conn, 'SELECT * FROM siswa WHERE nis="' . $_GET['nis'] .'"');
                                      ...
                                      <div class="row">
                                          <div class="col-lg-6">
                                                <div class="m-t-20">
                                                    ...
                                                    <input type="text" class="form-control" maxlength="50" name="nis" id="alloptions" placeholder="NIS" value="<?=$deti['nis']?>" required>
                                                </div>
                                                <div class="m-t-20">
                                                    <h5><b>NISN (Nomor Induk Siswa Nasional)</b></h5>
                                                    <input type="text" class="form-control" maxlength="50" name="nisn" id="alloptions" placeholder="NISN" value="<?=$deti['nisn']?>" required>
                                                </div>
                                                <div class="m-t-20">
                                                    <h5><b>Nama Siswa</b></h5>
                                                    <input type="text" class="form-control" maxlength="50" name="nama" id="alloptions" placeholder="Namasiswa" value="<?=$deti['nama']?>" required>
                                                </div>
                                                <div class="m-t-20">
                                                    <h5><b>Tempat</b></h5>
                                                    <input type="text" class="form-control" maxlength="50" name="tempat" id="alloptions" placeholder="Tempat" value="<?=$deti['tempat']?>" required>
                                                </div>
                                                <div class="m-t-20">
                                                    <h5><b>Tanggal Lahir</b></h5>
                                                    <input type="date" class="form-control" maxlength="40" name="tanggal_lahir" id="alloptions" placeholder="tanggal_lahir" value="<?=$deti['tanggal_lahir']?>" required>
                                                </div>
                                                <div class="m-t-20">
                                             ...
                                             <?php } ?>
                                                ...
                                                <div class="m-t-20">
                                                    ...
                                                    <input type="text" class="form-control" maxlength="40" name="pendidikan_sebelumnya" id="alloptions" placeholder="pendidikan_sebelumnya" value="<?=$deti['pendidikan_sebelumnya']?>" required>
                                                </div>
                                                <div class="m-t-20">
                                                    <h5><b>Alamat Siswa</b></h5>
                                                    <textarea class="form-control" name="alamat_siswa" style="margin-top: 10px" placeholder="Alamat" value="<?=$deti['alamat_siswa']?>"></textarea>
                                                </div>
                                                <div class="m-t-20">
                                                    <h5><b>Kelas</b></h5>
                                          ...
                                          <div class="col-lg-6">
                                            <div class="m-t-20">
                                                <h5><b>Nama Orang Tua : </b></h5>
                                                 <input type="text" class="form-control" maxlength="40" name="na_ayah" id="alloptions" placeholder="ayah" value="<?=$deti['na_ayah']?>" required>
                                                 <input type="text" class="form-control" style="margin-top: 10px" maxlength="40" name="na_ibu" id="alloptions" placeholder="ibu" value="<?=$deti['na_ibu']?>" required>
                                            </div>
                                            <div class="m-t-20">
                                                <h5><b>Pekerjaan Orang Tua : </b></h5>
                                                <input type="text" class="form-control" maxlength="40" name="pek_ayah" id="alloptions" placeholder="Ayah" value="<?=$deti['pek_ayah']?>" required>
                                                <input type="text" class="form-control" style="margin-top: 10px" maxlength="40" name="pek_ibu" id="alloptions" placeholder="Ibu" value="<?=$deti['pek_ibu']?>" required>
                                            </div>
                                            <div class="m-t-20">
                                                <h5><b>Wali Siswa : </b></h5>
                                                <input type="text" class="form-control" maxlength="40" name="na_wali" id="alloptions" placeholder="Nama" value="<?=$deti['na_wali']?>">
                                                <input type="text" class="form-control" style="margin-top: 10px" maxlength="40" name="pek_wali" id="alloptions" placeholder="Pekerjaan" value="<?=$deti['pek_wali']?>">
                                                <textarea class="form-control" name="alamat_wali" style="margin-top: 10px" placeholder="Alamat" value="<?=$deti['alamat_wali']?>"></textarea>
                                            </div>
                                            <div class="m-t-20">
                                                <h5><b>Foto</b></h5>
