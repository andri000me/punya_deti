            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <a href="tambahnilai.php"><button type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus">   Insert Nilai</i></button></a>
                        <hr class="bg-primary">
                        <div class="row">
                            <div class="col-lg-12"> 
                                <div class="card">
                                      ...
                                      <table class="table table-bordered" width="100%" cellspacing="0" id="myTable">
                                            <thead>
                                              <tr class="text-center">
                                                ...
                                                <th width="5%" rowspan="2">Nama</th>
                                                <th width="5%" rowspan="2">Kelas</th>
                                                <th width="5%" rowspan="2">Semester</th>
                                                <th colspan="6">Mata Pelajaran</th>
