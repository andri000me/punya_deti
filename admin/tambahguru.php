                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <form action="../admin/simpantmbhguru.php" method="POST" enctype="multipart/form-data">
                            <div class="m-t-20">
                                <h5><b>NIP (Nomor Induk Pegawai)</b></h5>
                                <input type="text" class="form-control" maxlength="50" name="nip" id="alloptions" placeholder="NIP" required>
                            </div>
                            <div class="m-t-20">
                                <h5><b>Nama</b></h5>
                                <input type="text" class="form-control" maxlength="50" name="nama" id="alloptions" placeholder="Nama" required>
                            </div>
                            <div class="m-t-20">
                            ...
                            <div class="m-t-20">
                                <h5><b>Jabatan</b></h5>
                                <input type="text" class="form-control" maxlength="50" name="jabatan" id="alloptions" placeholder="Jabatan" required>
                            </div>
                            <div class="m-t-20">
                                <h5><b>Bidang</b></h5>
                                <input type="text" class="form-control" maxlength="20" name="bidang" id="alloptions" placeholder="Bidang" >
                            </div>
                            <div class="m-t-20">
                                <h5><b>Foto</b></h5>
                            ...
                            <div class="m-t-20">
                                <button type="submit" name="btnSubmit" value="Submit" class="btn btn-primary">Submit</button>
                                 &nbsp;
                                <button type="submit" name="btnSubmit" value="Cancel" class="btn btn-success">Cancel</button>
                            </div>
                        </form>
                        </div>
                    </div><!-- end col -->
