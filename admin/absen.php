            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <a href="tambahabsen.php"><button type="button" class="btn btn-sm btn-primary"><i class="fa fa-plus">    Insert Absensi</i></button></a>
                        <hr class="bg-primary">
                        <div class="row">
                            <div class="col-lg-12"> 
                                <div class="card">
                                      ...
                                      <table class="table table-bordered" width="100%" cellspacing="0" id="myTable">
                                            <thead>
                                              <tr class="text-center">
                                                ...
                                                <th colspan="3" width="10%" height="10%">Absensi</th>
                                                <th width="10%">Aksi</th>
                                              </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            <?php
                                             ...
                                             $r = mysqli_query($conn, 'SELECT * FROM absensi');
